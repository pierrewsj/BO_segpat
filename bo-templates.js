...
window.BO_TEMPLATE_LIBRARY = Object.freeze({
  ...
  'Avaria em material, peça, equipamento ou vasilhame': {
    ...
    questions:[
      ...
      {id:'tipoDano',label:'Tipo de dano constatado',type:'textarea',required:true,placeholder:'Descreva o tipo de dano e, na mesma resposta, a extensão/quantidade visível quando aplicável.'},
...
window.BO_SUBMODEL_LIBRARY = Object.freeze({
  ...
  'Avaria constatada em veículo': [
    {id:'pane-caminhao',label:'Pane/falha mecânica de caminhão na planta',entities:{people:'required',vehicles:'required',materials:'hidden'},evidence:'recommended',replaceEvidenceRequirements:true,documentMode:'recommended',documentTypes:['MVM','Ordem de carga','Outro'],extraQuestions:[
...
// Somente perguntas que realmente alteram campos/obrigações ficam na etapa de direcionamento.
// As demais permanecem na apuração, evitando a sensação de que toda seleção muda o formulário.
...
window.BO_QUESTION_CONDITIONS = Object.freeze({
  ...
  'Avaria constatada em veículo': {
    causaDetalhe:{id:'causa',in:['Relatada pelo condutor','Constatada por evidência no local','Relacionada a outra ocorrência registrada']}
  },
  'Agressão física ou confronto entre pessoas': {
    lesaoDescricao:{id:'lesaoAparente',equals:'Sim, aparente'}
  },
  'Material ou equipamento localizado/recolhido': {
    proprietario:{id:'identificacaoDisponivel',in:['Sim','Parcial']}
  },
  'Suspeita de subtração de material em área interna': {
    indiciosDetalhe:{id:'indicios',equals:'Sim'}
  },
  'Divergência de carga, quantidade ou documentação': {
...
window.BO_QUESTION_EXCLUSIONS = Object.freeze({
  ...
  'Outra ocorrência de acesso ou credenciamento':['situacao','resultado'],
  'Acesso fora do horário autorizado':['resultado'],
  'Estacionamento ou circulação em desacordo com as normas':['orientacao'],
  'Veículo não identificado ou em situação suspeita':['resultado'],
  'Outra ocorrência envolvendo veículos ou circulação':['situacao','resultado'],
  ...
  'Outra ocorrência envolvendo materiais, peças ou cargas':['situacao','documentacao'],
  'Outra ocorrência envolvendo pessoas ou comportamento':['situacao','areaAcionada','resultado']
});
